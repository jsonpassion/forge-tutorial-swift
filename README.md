...
| 총 챕터 | 16개 | 🔲 진행 중 |
| 총 섹션 | 73개 | 🔲 진행 중 |
| Part 1: Swift 언어 기초 | 11개 섹션 | 🔲 대기 |
| Part 2: SwiftUI 기본 | 14개 섹션 | 🔲 대기 |
| Part 3: 실전 앱 개발 | 14개 섹션 | 🔲 대기 |
| Part 4: 사용자 경험 | 13개 섹션 | 🔲 대기 |
| Part 5: 출시와 확장 | 21개 섹션 | 🔲 대기 |
...
(입문)               (초급)               (중급)
          ...
          ┌─────────────┼──────────────┐
          ▼             ▼              ▼
     Ch12-13        ★ Ch14 ★       Ch15-16
   테스트/최적화    앱스토어 출시    확장/트렌드
    (품질 확보)    (크리티컬 골)     (보너스)
```
